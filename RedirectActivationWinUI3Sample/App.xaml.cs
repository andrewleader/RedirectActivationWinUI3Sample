...
namespace RedirectActivationWinUI3Sample
{
    ...
    public partial class App : Application
    {
        ...
        private void App_Activated(object sender, Microsoft.Windows.AppLifecycle.AppActivationArguments e)
        {
            ...
            // (Optional test validation step) Update the UI to indicate it received redirection
            // NOTE: Any UI operations must be on the UI thread as seen below
            m_window.DispatcherQueue.TryEnqueue(delegate
            {
                (m_window as MainWindow).SetAsReceivedRedirection();
            });
        }
    }
}
